### Websites for Development and Design

#### Fonts and Typography

- [Google Fonts](https://fonts.google.com/)
- [Font Squirrel](https://www.fontsquirrel.com/)
- [Font-size tool](https://typescale.com/)
- [Font Library](https://fontlibrary.org/)
- [Fonts in Use](https://fontsinuse.com/)
- [Typography Tools and Inspiration](https://typewolf.com/)

#### Colors

- [Color framework](https://tailwindcss.com/)
- [Choose color tone](https://yeun.github.io/open-color/)
- [Color palette: Flat UI Colors](https://flatuicolors.com/)
- [Color palette: Coolors](https://coolors.co/)
- [Choose the accent color (from main)](https://paletton.com/)
- [Choose lighter and darker versions of colors](https://maketintsandshades.com/)
- [Google Color Picker](https://g.co/kgs/XAMbPWb)
...
- [Open-source Illustrations: Storyset](https://storyset.com/)
- [SVG to XML Converter](http://inloop.github.io/svg2android/)
...
- [Cubic-bezier generator 2](https://easings.net/)
...
- [Website design: Land Book](https://land-book.com/)
- [Website design: OnePageLove](https://onepagelove.com/)
- [Website design: Awwwards](https://www.awwwards.com/)
- [Components design: Screenlane](https://screenlane.com/)

#### CSS

- [Online Code Editor for Frontend: Codepen](https://codepen.io/)
- [Check Browser Compatibility: CanIUse](https://caniuse.com/)
- [Check responsiveness: Sizzy](https://sizzy.co/)
